...
function Supplier() {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/supplier/get`, {
                headers: {
    ...
    const onConfirmDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/supplier/delete/${userId}`, {
                headers: {
                    Authorization: `Bearer ${user.token}`,
                },
            });
        ...
        <div className="admin dashboard">
            ...
            <div className="main-admin-dash loan-container">
                <div className="table-head">
                    <h2>Suppliers</h2>
                    <Link to={'/admin/create/supplier/'} style={{textDecoration:"none"}}><button><FaPlus />Add New</button></Link>
                        ...
                        <table className="equal-table">
                            ...
                            <tbody>
                                {data.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="8" className="no-loan-message">No suppliers</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
