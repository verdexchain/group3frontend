...
function Customers() {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/customer/get`, {
                headers: {
    ...
    const onConfirmDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/customer/delete/${userId}`, {
                headers: {
                    Authorization: `Bearer ${user.token}`,
                },
            });
                        ...
                        <table className="equal-table">
                            ...
                            <tbody>
                                {data.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="8" className="no-loan-message">No Customers</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
