...
function CreateSupplier() {
  ...
  const onDrop = useCallback((acceptedFiles) => {
    setFormData((prevFormData) => ({
      ...prevFormData,
      document: acceptedFiles[0], // assuming one document per supplier
    }));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.document) {
      supplierData.append('media', formData.document);
    }

    axios.post(`${process.env.REACT_APP_API_URL}/supplier/create`, supplierData, {
      headers: {
