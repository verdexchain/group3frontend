...
function Transaction() {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/admin/get-transactions`, {
                headers: {
    ...
    const onConfirmDelete = async () => {
        try {
            ...
            await axios.delete(`${process.env.REACT_APP_API_URL}/admin/delete-transaction/${transactionId}`, {
                headers: {
                    Authorization: `Bearer ${user.token}`,
                },
            });
    ...
    const handleSubmit = async (e) => {
        ...
        // try {
        //     await axios.post(
        //         `${process.env.REACT_APP_API_URL}/admin/update-balance/${transactionId}`,
        //         {
                        ...
                        <table className="equal-table">
                            ...
                            <tbody>
                                {data.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="8" className="no-loan-message">No Transactions</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
